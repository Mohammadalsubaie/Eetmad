...
const [hoveredCard, setHoveredCard] = useState<number | null>(null);
    ...
    return (
    	...
    	>
    				...
    				<div className='flex h-20 items-center justify-between'>
    					<div className='flex items-center gap-4'>
    						<motion.div whileHover={{ scale: 1.05 }} className='relative'>
    							...
    							>
    								<Sparkles className='absolute h-6 w-6' style={{ color: '#FAEAB1', opacity: 0.3 }} />
    		...
    		{/* Search & Filters */}
    		<section className='border-b py-12' style={{ backgroundColor: '#FFFFFF', borderColor: '#E0DCC8' }}>
    			<div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
    					...
    					{filteredProjects.map((project, idx) => (
    						<motion.div
    							...
    							style={{
    								...
    								borderColor: project.featured ? '#F7DD7D' : project.urgent ? '#C95454' : '#E0DCC8',
    							}}
    						>
    							{project.featured && (
    								<div
    								...
    								<div className='mb-6 flex items-start justify-between'>
    									<div className='flex flex-1 items-center gap-4'>
    										<div
    											...
    											style={{
    												background: 'linear-gradient(135deg, #34656D 0%, #284E54 100%)',
    											}}
    										>
    											<Building2
    											...
    											<div
    												...
    												style={{
    													background: 'radial-gradient(circle, #FAEAB1, transparent)',
    												}}
    											></div>
    										</div>
    		...
    		>
    			...
    			<div className='relative mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8'>
    				...
    				>
    					...
    					<p className='mx-auto mb-12 max-w-3xl text-2xl leading-relaxed' style={{ color: '#A4C5CA' }}>
