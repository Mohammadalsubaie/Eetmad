...
CREATE TABLE "Offer" (
    ...
    CONSTRAINT "uc_Offer_offerNumber" UNIQUE (
        "offerNumber"
    )
);
...
CREATE TABLE "Project" (
    ...
    CONSTRAINT "uc_Project_projectNumber" UNIQUE (
        "projectNumber"
    )
);
...
CREATE TABLE "Contract" (
    ...
    CONSTRAINT "uc_Contract_contractNumber" UNIQUE (
        "contractNumber"
    )
);
...
CREATE TABLE "Payment" (
    ...
    CONSTRAINT "uc_Payment_transactionId" UNIQUE (
        "transactionId"
    )
);
...
CREATE TABLE "PaymentGatewayTransaction" (
    ...
    CONSTRAINT "uc_PaymentGatewayTransaction_gatewayTransactionId" UNIQUE (
...
CREATE TABLE "Dispute" (
    ...
    CONSTRAINT "uc_Dispute_disputeNumber" UNIQUE (
        "disputeNumber"
    )
);
...
CREATE TABLE "Refund" (
    ...
    CONSTRAINT "uc_Refund_refundNumber" UNIQUE (
        "refundNumber"
    )
);
...
CREATE TABLE "PromotionCampaign" (
    ...
    CONSTRAINT "uc_PromotionCampaign_campaignCode" UNIQUE (
        "campaignCode"
    )
);
