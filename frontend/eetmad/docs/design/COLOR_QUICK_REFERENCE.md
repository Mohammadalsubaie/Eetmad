...
<div style={{ backgroundColor: cssVars.neutral.bg }}>
  ...
  {/* Title */}
  <h2 className="text-4xl font-bold" style={{ color: cssVars.secondary.DEFAULT }}>
    {t('title')}
  </h2>
...
<div style={{ background: cssVars.gradient.hero }}>
  ...
  {/* Title */}
  <h2 className="text-4xl font-bold" style={{ color: cssVars.neutral.bg }}>
    {t('title')}
  </h2>

  {/* Description */}
  <p className="text-lg" style={{ color: cssVars.neutral.textMuted }}>
    {t('description')}
  </p>
</div>
```
