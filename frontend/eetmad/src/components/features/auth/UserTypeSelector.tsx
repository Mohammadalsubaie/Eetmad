  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="text-center">
        <h3 className="mb-2 text-xl font-bold sm:text-2xl" style={{ color: cssVars.secondary.DEFAULT }}>
          {t('title')}
        </h3>
          ...
          return (
            ...
            >
              {isSelected && (
                ...
                >
                  <CheckCircle2 className="h-4 w-4 sm:h-5 sm:w-5" style={{ color: cssVars.neutral.surface }} />
                </motion.div>
              )}
              ...
              >
                <Icon
                  ...
                  style={{ color: isSelected ? cssVars.primary.DEFAULT : cssVars.neutral.textMuted }}
                />
              </div>

              <h4 className="mb-1.5 text-lg font-bold sm:mb-2 sm:text-xl" style={{ color: cssVars.secondary.DEFAULT }}>
