...
function ModernBiddingPlatform() {
  ...
  return (
    ...
    >
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mb-16 max-w-4xl text-center">
            ...
            >
              ...
              <h1
                className="mb-6 text-5xl leading-tight font-bold lg:text-6xl xl:text-7xl"
                style={{ color: '#FAF8F1' }}
              >
          ...
          <div className="flex flex-col items-center gap-6 lg:flex-row">
            <div className="relative w-full flex-1">
              ...
              <input
                ...
                className="focus:border-opacity-100 h-16 w-full rounded-2xl border-2 pr-16 pl-8 text-lg font-semibold transition-all outline-none"
                style={{
          ...
          <div className="mt-8 flex gap-3 overflow-x-auto pb-2">
            {categories.map((cat) => (
              <motion.button
                ...
                className={`rounded-xl border-2 px-6 py-3 font-bold whitespace-nowrap transition-all ${
            ...
            {filteredProjects.map((project, idx) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <h3 className="mb-4 text-2xl leading-snug font-bold" style={{ color: '#334443' }}>
                    {project.title}
                  </h3>
      ...
      {/* Footer */}
      <footer className="pt-20 pb-10" style={{ backgroundColor: '#334443' }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
