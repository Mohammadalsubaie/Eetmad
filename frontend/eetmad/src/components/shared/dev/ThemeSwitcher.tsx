  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-28 right-2 sm:bottom-36 sm:right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full shadow-lg transition-all hover:scale-110 touch-manipulation"
        style={{
                  ...
                  {filteredThemes.map((theme) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full rounded-lg px-3 py-2.5 text-left transition-all touch-manipulation min-h-[44px] ${
