...
export const mockConversations: Conversation[] = [
  {
    ...
    lastMessage: {
      ...
      senderId: 'supplier-1',
      content: 'شكراً لاهتمامك. يمكنني تقديم المزيد من التفاصيل.',
      messageType: 'text',
      attachments: [],
      isRead: false,
      readAt: null,
  ...
  },
  {
    ...
    lastMessage: {
      ...
      senderId: 'user-1',
      content: 'متى يمكننا تحديد موعد للاجتماع؟',
      messageType: 'text',
      attachments: [],
      isRead: true,
...
export const mockMessages: Message[] = [
  ...
  },
  {
    ...
    conversationId: 'conv-1',
    senderId: 'supplier-1',
    content: 'ما هي المعلومات المحددة التي تود معرفتها؟',
    messageType: 'text',
    attachments: [],
    isRead: false,
    readAt: null,
